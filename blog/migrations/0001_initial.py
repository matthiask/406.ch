    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_on', models.DateTimeField(null=True, verbose_name='published on', blank=True)),
                ('title', models.CharField(max_length=200, verbose_name='title')),
                ('slug', models.SlugField(unique=True, max_length=200, verbose_name='slug')),
                ('content', models.TextField(verbose_name='content', blank=True)),
                ('content_type', models.CharField(default=b'markdown', max_length=20, verbose_name='content type', choices=[(b'markdown', 'Markdown'), (b'html', 'HTML')])),
                ...
                ('categories', models.ManyToManyField(to='blog.Category', verbose_name='categories', blank=True)),
            ],
            options={
