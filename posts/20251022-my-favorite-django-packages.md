...
I have been working on [FeinCMS](https://github.com/feincms/feincms/) since 2009. So, it shouldn't surprise anyone that this is still my favorite way to
...
- [django-content-editor](https://pypi.org/project/django-content-editor/): The admin interface extension providing core components to build content editing interfaces.
...
- [micawber](https://pypi.org/project/micawber/): Micawber is my favorite tool to embed third party content (YouTube, Vimeo, whatever) when feincms3's own very limited embedding functionality is insufficient.
